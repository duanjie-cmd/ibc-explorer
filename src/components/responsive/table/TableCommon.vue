...
<script setup lang="ts">
    ...
    watch(
        ...
        (_new) => {
            ...
            if (needPagination.value) {
                ...
                needPagination.value && onPageChange(1, pageInfo.pageSize);
            }
            if (_new?.length === 0) {
    ...
    const onTableChange = (pagination: any, filters: any, sorter: any) => {
        ...
        // Modify default sorting rules, remove the unsorted state
        ...
        if (props.noPagination) {
            ...
            needPagination.value && onPageChange(1, pageInfo.pageSize); // reset去第一页
        }
    };
