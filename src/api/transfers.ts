...
export const getIbcTxsVolumeAPI = (params: IRequestIbcTxsVolume) => {
    const url = API_URL.ibcTxsVolumeUrl;
    executeCancel(undefined, url);
    return request<IResponse<IIbcTxsVolume>>({
        url,
        method: 'get',
        params: params,
        cancelToken: setExecuteCancel(undefined, url)
    });
};
