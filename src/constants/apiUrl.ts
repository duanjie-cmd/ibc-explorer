...
export const API_URL = {
    ...
    ibcTxsUrl: '/ibc/txs',
    ibcTxsVolumeUrl: '/ibc/txs/txs_volume',
    ...
    ibcOverviewTransferVolume: '/ibc/overview/chain_volume',
    ibcOverviewChainTransferVolumeTrend: '/ibc/overview/chain_volume_trend',
